    ...
    <>
      <nav className="flex items-center justify-center py-4 lg:py-8 absolute top-0 w-full z-30">
        <div className="w-[90%] flex justify-between gap-3">
          ...
          <div
            onClick={makeSearchActive}
            className="flex-1 lg:flex-none hidden md:flex lg:w-[525px] p-1 lg:py-[6px] lg:px-[10px] justify-between items-center rounded-[6px] border-[2px] border-gray-300"
          >
            <input
              type="text"
              className="outline-none w-full text-white placeholder:text-base placeholder:text-white bg-transparent"
              name="search"
              id="search"
          ...
          <div className="flex items-center gap-3 md:gap-6 justify-center">
            ...
            <button
              onClick={makeSearchActive}
              className="relative inline-block md:hidden outline-none"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="36"
        ...
        {search && (
          <div className="overflow-y-auto bg-[#000000] fixed top-0 h-screen w-full p-2">
            <button
              ...
              className="text-white font-medium text-base bg-rose-600 p-1 px-2 rounded-md"
            >
              close
            </button>
            <div className="flex items-center justify-center w-full">
              <div className="w-full flex lg:w-[525px] p-1 py-3 lg:py-[6px] lg:px-[10px] justify-between items-start border-b-[1px] border-gray-300">
                ...
                <button
                  onClick={clearInput}
                  className="text-white font-medium text-sm bg-rose-600 w-[26px] h-[26px] rounded-full"
                >
                  X
                </button>
              </div>
            ...
            {isLoading === true ? (
              <Image
                src="/loader.svg"
                className="lg:w-[60px] lg:h-[60px] absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]"
                width={50}
                height={50}
                alt="preloader"
              />
